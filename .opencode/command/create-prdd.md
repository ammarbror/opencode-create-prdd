...
Untuk file EN, terjemahkan semua heading section and header kolom tabel ke English (contoh: `| Priority | Requirement | Acceptance Criteria |`, `| Method | Path | Purpose | Authentication |`, `| Risk | Probability | Impact | Mitigation | Owner |`) dengan struktur dan urutan 9 section yang sama persis.
